...
namespace tktk
{
	void SystemSphereMeshMaker::makeImpl(int meshId, int materialId)
	{
		int uMax = 24;
		int vMax = 12;
		...
		// メッシュデータを作成
		MeshManager::create(meshId, D3D11_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP, vertexBufferParams, indexBufferParams, materialSlotsParams);
