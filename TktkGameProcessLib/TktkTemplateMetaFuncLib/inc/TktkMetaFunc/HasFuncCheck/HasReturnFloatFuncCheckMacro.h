#ifndef HAS_RETURN_FLOAT_FUNC_CHECK_MACRO_H_
#define HAS_RETURN_FLOAT_FUNC_CHECK_MACRO_H_

#include <type_traits>

#define HAS_RETURN_FLOAT_FUNC_CHECK(funcName)																		\
																													\
...
{																													\
	template <class T, typename std::enable_if<has_ ## funcName ## _member<T, Args...>::value>::type* = nullptr>	\
	static float checkAndRun(T runClass, Args... params)															\
	{																												\
...
#endif // !HAS_RETURN_FLOAT_FUNC_CHECK_MACRO_H_